...
@pytest.fixture
def resp(client_usuario_logado, aula: Aula):
    return client_usuario_logado.get(reverse("modulos:aula", kwargs={"slug": aula.slug}))
...
@pytest.fixture
def resp_sem_usuario(client, aula: Aula):
