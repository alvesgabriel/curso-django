...
@pytest.fixture
def resp_home_usuario_logado(client_usuario_logado, db):
...
def test_botao_sair_disponivel(resp_home_usuario_logado):
    assert_contains(resp_home_usuario_logado, "Sair")


def test_usario_nome_disponivel(resp_home_usuario_logado, usuario_logado):
    assert_contains(resp_home_usuario_logado, usuario_logado.first_name)


def test_link_logout_disponivel(resp_home_usuario_logado):
